...
<%
	CartDTO cDTO = (CartDTO) request.getAttribute("goods");
	...
	String uid=mDTO.getUserid();
	String post=mDTO.getPost();
	String addr1=mDTO.getAddr1();
	String addr2=mDTO.getAddr1();
		...
		<tr>
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan="4">
							<hr size="1" color="CCCCCC"  width="115%">
						</td>
					</tr>
