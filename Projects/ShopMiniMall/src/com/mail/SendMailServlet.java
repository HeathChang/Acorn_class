...
public class SendMailServlet extends HttpServlet {
	...
	System.out.println(mailTo+"\t"+userid);
		String host = "smtp.naver.com"; //네이버 메일 사용(개인 메일)
	    String subject = "2번째.백엔드과정에서 보내는 아이디 확인 메일입니다";
	    String from = "보내는 사람@naver.com"; //보내는 메일//////////////////////////////////
	    String fromName = "Test"; //보내는 사람 
	    String to = "받는사람@naver.com"; //받는 메일///////////////////////////////////
	    String content = "2번째.백엔드과정에서 보내는 아이디 확인 메일입니다. 귀하의 아이디:" + userid;//메일 내용
	   ...
	   try{
	    ...
	    props.put("mail.smtp.user", from);
	     ...
	     Authenticator auth = new SendMail(); //snedMail 호출
