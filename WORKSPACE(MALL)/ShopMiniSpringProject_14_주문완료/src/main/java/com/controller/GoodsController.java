...
public class GoodsController {
	...
	@RequestMapping("/loginCheck/orderDone")//주문하기 
	public String orderConfirm(OrderDTO oDTO,int orderNum,HttpSession session, RedirectAttributes xxx) {
		System.out.println(oDTO+"\t"+orderNum);
		MemberDTO dto = (MemberDTO) session.getAttribute("login");
		oDTO.setUserid(dto.getUserid());
		service.orderDone(oDTO, orderNum); //inser && delete
